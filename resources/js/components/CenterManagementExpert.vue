                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Centers Table</h3>
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-hover" id="datatable">
                                ...
                                <tr v-for="center in centers.data" :key="center.id">
                                    <td>{{ center.id }}</td>
                                    <td>{{ center.title }}</td>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-primary" @click="updatemodelCenter(center)">
                                            Edit </a>
                                    </td>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addNewCenterLabel">Update Center Info</h5>
                        ...
                        <form @submit.prevent="updateCenter(form)">
...
<script>
import {updateCenter, loadCenter} from '../api.js';
...
export default {
    ...
    methods: {
        ...
        getResults(page = 1) {
            axios.get('all-centers/' + this.pagin + '?page=' + page)
                .then(response => {
