            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Liste of Docteurs</h3>
                        ...
                        <div class="card-tools">
                            <!--               <button
                              ...
                              >
                                Add new Faq <i class="fas fa-question"></i>
                              </button> -->
                        </div>
                    </div>
                    <!-- /.card-header -->
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="UpdateUserLabel">Update Users Info</h5>
...
<script>
import {showUserinfo, approuved, inactivated, loadUsers, deleteUser, updateUser, validated} from '../api.js';
...
export default {
    ...
    methods: {
        ...
        getResults(page = 1) {
            axios.get('all-doctors/' + this.pagin + '?page=' + page)
                .then(response => {
    ...
    async created() {
        ...
        Fire.$on("AfterUpdateUser", async () => {
            this.users = await loadUsers(this.pagin);
        });
